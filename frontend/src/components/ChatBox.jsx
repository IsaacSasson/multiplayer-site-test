...
const ChatBox = () => {
  ...
  return (
    <div className="absolute left-4 bottom-4 w-64 md:w-80 z-40">
      <div className={`${bgColor} bg-opacity-90 rounded-lg shadow-lg overflow-hidden transition-all duration-300`}>
        {/* Chat header */}
        <div 
